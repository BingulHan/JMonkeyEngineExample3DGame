...
This is the readme for JExampleGame, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. JExampleGame) > Ok.
...
- To run the project find JExampleGame.java (which will be in under src/main/java/dev/bingulhan) and right click > Run 'JExampleGame'
